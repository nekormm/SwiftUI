    ...
    var body: some View {
       ...
       return ZStack {
          ...
          Circle()
             ...
             .stroke(
               LinearGradient(colors: [Color(color1), Color(color2)], startPoint: .leading, endPoint: .trailing), style: StrokeStyle(lineWidth: 5 * multiplier , lineCap: .round, lineJoin: .round, miterLimit: .infinity, dash: [20,0], dashPhase: 5)
             )
